...
<head>
    ...
    <title>Classes Dark | IperSki</title>
        ...
        <div class="breadcrumbs">
            <div class="wrap">
                <div class="wrap_float">
                    <a href="main-dark.php">Home</a> / <a href="classes-dark.php" class="current">Classes</a>
                </div>
            </div>
        </div>
            ...
            <div class="wrap">
                <div class="wrap_float">
                    ...
                    <div class="classes_list">
                        <a href="classes-single-dark.php" class="classes_item" style="background-color: #476EFF" data-color-type="dark">
                            ...
                            <div class="classes_item_left">
                                <p class="block _category">Swimming pool</p>
                                <h3 class="block _title">Fitness for advanced</h3>
                                <div class="_author">
                                    <div class="img ie-img">
                                        <img src="img/placeholder.jpg" alt="">
                                    </div>
                                    <p class="block name">Victor Shibut</p>
                                </div>
                            </div>
                        </a>

                        <a href="classes-single-dark.php" class="classes_item" style="background-color: #FF5100" data-color-type="dark">
                            <div class="classes_item_right">
                                <div class="image ie-img">
                                    <img class="js-image" src="img/placeholder.jpg" alt="">
                                </div>
                            ...
                            <div class="classes_item_left">
                                <p class="block _category">Fitness</p>
                                <h3 class="block _title">Group programs</h3>
                                <div class="_author">
                                    <div class="img ie-img">
                                        <img src="img/placeholder.jpg" alt="">
                                    </div>
                        ...
                        <a href="classes-single-dark.php" class="classes_item" style="background-color: #7749FF" data-color-type="dark">
                            <div class="classes_item_right">
                                <div class="image ie-img">
                                    <img class="js-image" src="img/placeholder.jpg" alt="">
                                </div>
                            ...
                            <div class="classes_item_left">
                                <p class="block _category">Yoga</p>
                                <h3 class="block _title">Antigravity yoga in the hammocks</h3>
                                <div class="_author">
                                    <div class="img ie-img">
                                        <img src="img/placeholder.jpg" alt="">
                                    </div>
                                    <p class="block name">Maya Delia</p>
                                </div>
                            </div>
                        </a>

                        <a href="classes-single-dark.php" class="classes_item" style="background-color: #FF4F58" data-color-type="dark">
                            <div class="classes_item_right">
                                <div class="image ie-img">
                                    <img class="js-image" src="img/placeholder.jpg" alt="">
                                </div>
                        ...
                        <a href="classes-single-dark.php" class="classes_item" style="background-color: #FF9D00" data-color-type="dark">
                            <div class="classes_item_right">
                                <div class="image ie-img">
                                    <img class="js-image" src="img/placeholder.jpg" alt="">
                                </div>
                            ...
                            <div class="classes_item_left">
                                <p class="block _category">CrossFit</p>
                                <h3 class="block _title">CrossFit Basics</h3>
                                <div class="_author">
                                    <div class="img ie-img">
                                        <img src="img/placeholder.jpg" alt="">
                                    </div>
                        ...
                        <a href="classes-single-dark.php" class="classes_item" style="background-color: #E1FF7E" data-color-type="light">
                            <div class="classes_item_right">
                                <div class="image ie-img">
                                    <img class="js-image" src="img/placeholder.jpg" alt="">
                                </div>
                        ...
                        <a href="classes-single-dark.php" class="classes_item" style="background-color: #FFDC49" data-color-type="light">
                            <div class="classes_item_right">
                                <div class="image ie-img">
                                    <img class="js-image" src="img/placeholder.jpg" alt="">
                                </div>
                        ...
                        <a href="classes-single-dark.php" class="classes_item" style="background-color: #343434" data-color-type="dark">
                            <div class="classes_item_right">
                                <div class="image ie-img">
                                    <img class="js-image" src="img/placeholder.jpg" alt="">
                                </div>
