            ...
            <div class="wrap">
                <div class="wrap_float">
                    ...
                    <div class="classes_list">
                        ...
                        <a href="classes-single.php" class="classes_item" style="background-color: #FF5100" data-color-type="dark">
                            <div class="classes_item_right">
                                <div class="image ie-img">
                                    <img class="js-image" src="img/placeholder.jpg" alt="">
                                </div>
                        ...
                        <a href="classes-single.php" class="classes_item" style="background-color: #7749FF" data-color-type="dark">
                            <div class="classes_item_right">
                                <div class="image ie-img">
                                    <img class="js-image" src="img/placeholder.jpg" alt="">
                                </div>
                        ...
                        <a href="classes-single.php" class="classes_item" style="background-color: #FF4F58" data-color-type="dark">
                            <div class="classes_item_right">
                                <div class="image ie-img">
                                    <img class="js-image" src="img/placeholder.jpg" alt="">
                                </div>
                        ...
                        <a href="classes-single.php" class="classes_item" style="background-color: #FF9D00" data-color-type="dark">
                            <div class="classes_item_right">
                                <div class="image ie-img">
                                    <img class="js-image" src="img/placeholder.jpg" alt="">
                                </div>
                        ...
                        <a href="classes-single.php" class="classes_item" style="background-color: #E1FF7E" data-color-type="light">
                            <div class="classes_item_right">
                                <div class="image ie-img">
                                    <img class="js-image" src="img/placeholder.jpg" alt="">
                                </div>
                        ...
                        <a href="classes-single.php" class="classes_item" style="background-color: #FFDC49" data-color-type="light">
                            <div class="classes_item_right">
                                <div class="image ie-img">
                                    <img class="js-image" src="img/placeholder.jpg" alt="">
                                </div>
                        ...
                        <a href="classes-single.php" class="classes_item" style="background-color: #343434" data-color-type="dark">
                            <div class="classes_item_right">
                                <div class="image ie-img">
                                    <img class="js-image" src="img/placeholder.jpg" alt="">
                                </div>
