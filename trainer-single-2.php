...
<head>
    ...
    <title>Trainer single 2 | IperSki</title>
...
<body data-color="#7749FF" data-color-type="dark">
            ...
            <div class="left" style="background-image: url(img/placeholder.jpg);">
                <div class="content">
                    <div class="breadcrumbs">
                        <a href="..">Home</a> / <a href="trainers.php">Trainers</a> / <a href="trainer-sinlge.php" class="current">Maya Delia</a>
                    </div>
                    <h1 class="page_title">Maya Delia</h1>
                    <p class="page_subtitle">Strength training</p>
                    <div class="socials">
                    ...
                    <div class="links">
                        <button href="#" class="btn js-change getModal" data-href="#join" style="background: none;">JOIN NOW</button>
                        <a href="#shedule" class="anchor js-anchor">Schedule</a>
                    </div>
                </div>
            </div>
            <div class="right js-change" style="background: none">
