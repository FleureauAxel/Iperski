...
<body class="dark-theme">
    ...
    <div class="container page faq-page">
        ...
        <div class="breadcrumbs">
            <div class="wrap">
                <div class="wrap_float">
                    <a href="main-dark.php">Home</a> / <a href="faq-dark.php" class="current">FAQ</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="section_content">
                        ...
                        <div class="right">
                            <div class="sidebar_block ask_trainer">
                                ...
                                <button data-href="#ask" class="btn getModal">ASK A QUESTION</button>
                            </div>
                        </div>
                    </div>
                </div>
