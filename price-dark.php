...
<head>
    ...
    <title>Price Dark | IperSki</title>
        ...
        <div class="breadcrumbs">
            <div class="wrap">
                <div class="wrap_float">
                    <a href="main-dark.php">Home</a> / <a href="price-dark.php" class="current">Prices</a>
                </div>
            </div>
        </div>
        <section class="price_section">
            <div class="wrap">
                <div class="wrap_float">
                    ...
                    <div class="links">
                        <button data-href="#join" class="btn getModal">BUY NOW $235</button>
                        <a href="#lessons-accordion" class="lessons-link js-anchor">INDIVIDUAL LESSONS</a>
                    </div>
                    <div class="clubcard">
                        <div class="left">
                            <img src="img/card-dark.png" alt="">
                        </div>
                        <div class="right">
                            <div class="_title">The club card includes</div>
                            <ul>
                    ...
                    <div class="lessons-accordion" id="lessons-accordion">
                        ...
                        <div class="lessons">
                            <div class="accordion-item js-price-item" data-color="#E1FF7E" data-color-type="light">
                                <div class="lessons_top">
                                    <h3 class="title">Individual Crossfit lesson</h3>
                                ...
                                <div class="lessons_bottom">
                                    ...
                                    <div class="lessons_list">
                                        <div class="lesson-item">
                                            ...
                                            <div class="_info">
                                                <h4 class="_title">1 individual training</h4>
                                                <div class="_bottom">
                                                    <div class="author">
                                                        <div class="photo">
                                                            <img src="img/placeholder.jpg" alt="">
                                                    ...
                                                    <button data-href="#buy" class="btn getModal">BUY NOW</button>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="accordion-item js-price-item" data-color="#7749FF" data-color-type="dark">
                                <div class="lessons_top">
                                    <h3 class="title">Individual Crossfit lesson</h3>
                                    <div class="cost">From $ 3235</div>
                                </div>
