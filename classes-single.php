...
<head>
    ...
    <title>Classes single | IperSki</title>
...
<body data-color="#FF5100" data-color-type="dark">
    <div class="container classes_page classes-single-page">
        ...
        <section class="classes_header">
            ...
            <div class="right js-change" style="background-color: inherit">
                <div class="video_link getModal js-video" data-href="#video" data-src="XEwYuqMWo8U" style="background-image: url(img/placeholder.jpg)">
