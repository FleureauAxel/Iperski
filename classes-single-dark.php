...
<head>
    ...
    <title>Classes single Dark | IperSki</title>
                    ...
                    <div class="left">
                        <div class="content">
                            <div class="breadcrumbs">
                                <a href="main-dark.php">Home</a> / <a href="classes-dark.php">Classes</a> / <a href="#" class="current">Classes single</a>
                            </div>
                            <div class="parent">
        ...
        <section class="trainers-block">
            <div class="wrap">
                <div class="wrap_float">
                    ...
                    <div class="section_content">
                        <a href="trainer-single-dark.php" class="item">
                    ...
                    <div class="section_content">
                        ...
                        <div class="right">
                            <div class="sidebar_block sign_up_block">
                                ...
                                <a href="price-dark.php" class="btn">SIGN UP TODAY</a>
                            </div>
                ...
                <div class="wrap_float">
                    ...
                    <div class="section_content">
                        <div class="photo-slider hidden-scroll lightgallery" id="photo-slider">
                            <a href="img/placeholder.jpg" class="slide-item">
                                <img src="img/placeholder.jpg" alt="">
                            </a>
                            <a href="img/placeholder.jpg" class="slide-item">
                                <img src="img/placeholder.jpg" alt="">
