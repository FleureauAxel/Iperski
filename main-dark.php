...
<body class="dark-theme">
    <div class="container">
        ...
        <section class="top_slider">
            <div class="slider_wrap" id="main_slider-dark">
                <div class="slide" style="background-image: url(img/placeholder.jpg)">
                    <div class="wrap">
                        <div class="wrap_float">
                            <div class="slide_content">
                                ...
                                <div class="info">
                                    <div class="play-btn getModal js-video" data-href="#video" data-src="XXXXXX"></div>
                                    <div class="info-text">
                                        The Best Crossfit Classes <br>With Professionals
                                    </div>
                                    <a href="classes-single-dark.php" class="btn">JOIN NOW</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section_content">
                        <div class="trainers_slider" id="trainers_slider">
                            <div class="item">
                                ...
                                <a href="trainers-dark.php" class="info">
                                    <div class="name">John Digistrict</div>
        ...
        <section class="video_section ie-img">
            <img src="img/placeholder.jpg" class="img" alt="">
            <div class="wrap">
                <div class="wrap_float">
                    <h2 class="title">
